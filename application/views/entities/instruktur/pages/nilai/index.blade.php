                        ...
                        <table id="table-data" class="table table-bordered table-striped text-center table-responsive-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $info_data->nilai_akhir }}</td>
									<td>
										<a href="{{ site_url('instruktur/nilai/edit/'.$info_data->id) }}" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i> Ubah</a>
										<a href="{{ site_url('instruktur/nilai/destroy/'.$info_data->id) }}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Hapus</a>
                                    </td>
								</tr>
								@endforeach
                            </tbody>
