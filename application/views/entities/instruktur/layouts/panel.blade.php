...
<head>
    ...
    <title>{{ getenv('APP_NAME') }} | Panel(Instruktur) - {{ $title }}</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        @include('entities.instruktur.includes.header')
        @include('entities.instruktur.includes.leftsider')
        <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper">
            @include('entities.instruktur.includes.messages')
            @yield('content')
        </div>
        <!-- /.content-wrapper -->
        @include('entities.instruktur.includes.footer')
        <!-- /.control-sidebar -->
    </div>
    <!-- ./wrapper -->
