...
<aside class="main-sidebar sidebar-light-danger elevation-4">
    <!-- Brand Logo -->
    <a href="{{ site_url('pelajar') }}" class="brand-link bg-gray-light">
    ...
    <div class="user-profile d-flex">
        ...
        <a href="#" class="profile-link">
            <img src="{{ asset('cpanel/img/_pelajar.png') }}" alt="Logo" class="brand-image img-circle elevation-3">
        ...
        <nav class="mt-2 sidebar-container">
			...
			with font-awesome or any other icon font library -->
				<li class="nav-item {{ @$activeMenu == 'beranda' ? 'menu-open' : '' }}">
					<a href="{{ site_url('pelajar') }}" class="nav-link {{ @$activeMenu == 'beranda' ? 'active' : '' }}">
				...
				<li class="nav-item {{ @$activeMenu == 'kursus' ? 'menu-open' : '' }}">
					<a href="{{ site_url('pelajar/kursus') }}" class="nav-link {{ @$activeMenu == 'kursus' ? 'active' : '' }}">
						<i class="nav-icon fa fa-circle"></i>
						<p>
							Kursus
						</p>
