...
<head>
    ...
    <title>{{ getenv('APP_NAME') }} | Panel(Petugas) - {{ $title }}</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        @include('entities.petugasadministrasi.includes.header')
        @include('entities.petugasadministrasi.includes.leftsider')
        <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper">
            @include('entities.petugasadministrasi.includes.messages')
            @yield('content')
        </div>
        <!-- /.content-wrapper -->
        @include('entities.petugasadministrasi.includes.footer')
        <!-- /.control-sidebar -->
    </div>
    <!-- ./wrapper -->
