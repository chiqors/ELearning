...
<section class="content">
    <div class="container-fluid">
        <form role="form" action="{{ @$info ? site_url('petugasadministrasi/instruktur/update/'.@$info->id) : site_url('petugasadministrasi/instruktur/store') }}" enctype="multipart/form-data" method="POST">
            <div class="row">
                <!-- left column -->
                <div class="col-md-12">
                            ...
                            <div class="row">
								<div class="col-6">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" name="pendidikan_terakhir" value="{{ @$info->pendidikan_terakhir }}">
									</div>
									<div class="form-group">
