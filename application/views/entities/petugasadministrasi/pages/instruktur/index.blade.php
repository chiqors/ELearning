        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Instruktur</h3>
                        ...
                        <table id="table-data" class="table table-bordered table-striped text-center table-responsive-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
									...
									<td>
										<a href="{{ site_url('petugasadministrasi/instruktur/show/'.$info_data->id) }}" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> Lihat</a>
										<a href="{{ site_url('petugasadministrasi/instruktur/edit/'.$info_data->id) }}" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i> Ubah</a>
										<a href="{{ site_url('petugasadministrasi/instruktur/destroy/'.$info_data->id) }}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Hapus</a>
                                    </td>
								</tr>
								@endforeach
                            </tbody>
