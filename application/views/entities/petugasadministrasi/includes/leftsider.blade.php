...
<aside class="main-sidebar sidebar-light-warning elevation-4">
    ...
    <div class="user-profile d-flex">
        ...
        <a href="#" class="profile-link">
            <img src="{{ asset('cpanel/img/_petugasadministrasi.png') }}" alt="Logo" class="brand-image img-circle elevation-3">
        ...
        <nav class="mt-2 sidebar-container">
			...
			with font-awesome or any other icon font library -->
				<li class="nav-item {{ @$activeMenu == 'kursus' ? 'menu-open' : '' }}">
					<a href="{{ site_url('petugasadministrasi/kursus') }}" class="nav-link {{ @$activeMenu == 'pengguna' ? 'active' : '' }}">
				...
				<li class="nav-item {{ @$activeMenu == 'pelajar' ? 'menu-open' : '' }}">
					<a href="{{ site_url('petugasadministrasi/pelajar') }}" class="nav-link {{ @$activeMenu == 'pendapatan' ? 'active' : '' }}">
				...
				<li class="nav-item {{ @$activeMenu == 'pembayaran' ? 'menu-open' : '' }}">
					<a href="{{ site_url('petugasadministrasi/pembayaran') }}" class="nav-link {{ @$activeMenu == 'pendapatan' ? 'active' : '' }}">
						<i class="nav-icon fa fa-line-chart"></i>
						<p>
							Pembayaran
						</p>
				...
				<li class="nav-item {{ @$activeMenu == 'petugas' ? 'menu-open' : '' }}">
					<a href="{{ site_url('petugasadministrasi/petugas') }}" class="nav-link {{ @$activeMenu == 'pendapatan' ? 'active' : '' }}">
						<i class="nav-icon fa fa-line-chart"></i>
						<p>
							Petugas
						</p>
